...
public class NetworkConnectivityListener {
	...
	private ConnectivityBroadcastReceiver mReceiverFlightMode;
	...
	public NetworkConnectivityListener() {
		...
		mReceiverFlightMode= new ConnectivityBroadcastReceiver();
	}
	...
	public synchronized void startListening(Context context) {
		if (!mListening) {
			...
			context.registerReceiver(mReceiverFlightMode, intentFilter);
	...
	public synchronized void stopListening() {
		if (mListening) {
			...
			mContext.unregisterReceiver(mReceiverFlightMode);
